function aaa = ARBITRAGE_NPC_COMPARISON_1a_MEGA(bat_cap, pbidi_cap_ch,pbidi_cap_disch)
...
fname3 = sprintf('ARBITRAGE_NPC_COMPARISON_1a_%.0f_%.0f_%.0f_%s.mat',bat_cap,pbidi_cap_ch/(nbattch*pbidi_eff_RECTIFIER),-pbidi_cap_disch,ScenarioID);
save(fname3)
